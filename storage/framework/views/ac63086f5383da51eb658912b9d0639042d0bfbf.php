                        ...
                        <p>3. Décrivez nous votre bien et les disponibilités</p>                     
                                ...
                                <div class="col-md-6">
                                    <select id="select_category" name="category_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo($category->id);?>" <?php if(old('category_id') == $category->id): ?> selected="selected" <?php endif; ?>><?php echo($category->category);?></option>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                        <a href="<?php echo e(route('house.create_step2')); ?>" class="btn btn-primary">Retour</a>
