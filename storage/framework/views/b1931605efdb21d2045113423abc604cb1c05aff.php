<?php echo Form::open(['method'=>'GET','url'=>$url,'class'=>'form','role'=>'search']); ?>
        ...
        <div class="form-group<?php echo e($errors->has('start_date') ? ' has-error' : ''); ?><?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control date-field-home" id="fromHome" placeholder="Date de départ" name="start_date" value="<?php echo e(old('start_date')); ?>" />
                <input type="text" class="form-control date-field-home" id="toHome" placeholder="Date de retour" name="end_date" value="<?php echo e(old('end_date')); ?>" />
