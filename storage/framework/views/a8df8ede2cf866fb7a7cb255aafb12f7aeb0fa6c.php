                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">         
                    <div class="card-houses h-100">       
                        ...
                        <div class="card-block">
                            <div class="card-body">
                                <h3 class="card-title"><a href="<?php echo e(action('UsersController@showHouse', $house->id)); ?>"> <?php echo(substr($house->title, 0, 30));?> </a><br> - <?php echo(substr($house->ville, 0, 25));?> </h3>
                            </div>
