            ...
            <div class="col-lg-4 col-md-4">
                <div class="thumbnail">
                    <div class="card h-100">
                        <a href="<?php echo e(action('AdminController@showhistoriques', $historique->id)); ?>"><img class="img-responsive img_house" src="<?php echo e(asset('img/houses/'.$historique->house->photo)); ?>"></a>
                        <div>
                            <h4 class="title card-title text-center">
                                <a href="<?php echo e(route('admin.showhistoriques', $historique->id)); ?>"><?php echo e($historique->house->title); ?></a>
                            </h4>
