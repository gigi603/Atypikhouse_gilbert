...
<div class="container-fluid" role="reservations">
    <h1 class="text-center title title-intro">Mes réservations</h1>
    <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">         
                        <div class="card-houses h-100">       
                            ...
                            <div class="card-block">
                                <div class="card-body">
                                    <h2 class="card-title title-houses"><a href="{{route('user.showreservations', $reservation['id']) }}"> {{$reservation->house->title}} </a></h3>
                                </div>
                                ...
                                @endif
                                <!-- <h3 class="text-center"><a href="{{route('user.showreservations', $reservation['id']) }}" class="btn btn-primary btn-color">Voir</a></h3>-->
                                </div>
